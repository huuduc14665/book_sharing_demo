...
-- Drop the old constant
ALTER TABLE employees DROP CONSTRAINT employee_pk;

-- Create a new constant on the same columns but in a different order
ALTER TABLE employees ADD CONSTRAINT employee_pk PRIMARY KEY (subsidiary_id, employee_id);
